                      ...
                      <div class="col-md-6 col-sm-6">
                        <div class="your-details">
                          ...
                          <div class="form-row">
                            ...
                            <input type="text" class="input namefild" name="firstname" required>
                          </div>
                          <div class="form-row">
                            <label class="lebel-abs">
                              Họ
                            ...
                            <input type="text" class="input namefild" name="lastname" required>
                          </div>
                          <div class="form-row">
                            <label class="lebel-abs">
                              Email
                          ...
                          <div class="form-row">
                            ...
                            <input type="text" class="input namefild" name="sdt" required>
                          </div>
                          <div class="pass-wrap">
                            <div class="form-row">
                              <label class="lebel-abs">
                            ...
                            <div class="form-row">
                              ...
                              <input type="password" class="input cpass" name="passre" required>
                            </div>
                          </div>
                          <p>
                          </p>
                      ...
                      <div class="col-md-6 col-sm-6">
                        <div class="your-details">
                          ...
                          <div class="form-row">
                            ...
                            <input type="text" class="input namefild" name="district" required>
                          </div>
                          <p class="privacy">
                            ...
                            <span class="text">
                              Khi bạn nhấn Đăng ký, bạn đã đồng ý thực hiện mọi giao dịch mua bán theo<a href="#"
                                class="red"> điều kiện sử dụng và chính sách của cửa hàng</a>
                            </span>
