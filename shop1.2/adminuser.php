            ...
            <div class="container">
                <div class="ListEmployee">
                    <table class="table" border="2" width="10%">
                      ...
                      <?php     
                      $layuser=$db->chen("SELECT * FROM `khachhang`"); 
                             while($tranto=$layuser->fetch()){
       ?>
                        <tr style="height: 100px;">
                                <td><?php echo $tranto['MAKH'] ?></td>
                                <td><?php echo $tranto['TENKH'] ?></td>
                                <td><?php echo $tranto['SDT'] ?></td>
                                <td><?php echo $tranto['DIACHI'] ?></td>
                                <td><?php echo $tranto['USERNAME'] ?></td>
                                <td><?php echo $tranto['PASSWORD'] ?></td>
                                <td><?php echo $tranto['EMAIL'] ?></td>
                                <td><a href="adminuserManagement.php?action=fix&id=<?php echo $tranto['MAKH']?>">Sửa</a></td>
                                <td><a href="adminuserManagement.php?action=delete&id=<?php echo $tranto['MAKH']?>">Xóa</a></td>
                        </tr>
                             <?php } ?>
                    </table>
                </div>
